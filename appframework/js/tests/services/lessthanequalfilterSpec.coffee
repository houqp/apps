...
describe '_LessThanEqualFilter', ->


	beforeEach module 'OC'

	beforeEach inject (_LessThanEqualFilter, _Model, _ModelFilter) =>
		@filter = _LessThanEqualFilter
	...
	it 'should have a correct hash', =>
		expect(new @filter('id', 3).hashCode()).toBe('lessthanequal_id_3')		
